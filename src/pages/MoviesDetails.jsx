...
const MoviesDetails = () => {
    ...
    return (
      <>
        <div className=" md:flex h-full w-full">
          <img
            className="md:self-start w-[200px] h-[300px] md:w-[250px] md:h-[350px] xl:w-[300px] xl:h-[400px]"
            src={Poster}
          ...
          <div className="text-white p-4 pt-9 max-w-[512px] xl:pt-17  xl:pl-7">
            ...
            <p className="text-sm text-gray-300 xl:not-first:text-[16px]">
              {Plot}
            </p>
            <p className="text-md font-semibold mt-3 mb-3 text-gray-300 xl:text-lg">
              Status: Released | Date : {Released} | {Runtime} long{" "}
            </p>
            <p className="text-md font-bold mt-3 mb-3 text-gray-300">
            ...
            <p className="font-bold">
              Actors : <span className="font-semibold">{Actors}</span>
            </p>
            <p className="font-bold">
              Rating :{" "}
              <span className="font-semibold">
                {imdbRating} imdb , {imdbVotes} votings
              </span>
            </p>
  ...
  return (
    <div className="max-h-[100vh] flex flex-col">
      <Header />
      <div
        className="bg-cover min-h-[100vh] pl-4 pt-4 md:pl-8 md:pt-8   overflow-auto scrollbar-hide"
        style={{
